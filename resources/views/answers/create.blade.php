                        ...
                        <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
                            <div class='max-w-md mx-auto space-y-6'>
                                <form action="{{ route('answers.store', ['application' => $application->id]) }}" method="POST">
                                    ...
                                    <textarea name="body" id="" class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded" rows="5" required></textarea>
                                    ...
                                    <a href="{{ route('dashboard') }}" class="py-3 px-6 my-2 bg-red-500 text-white font-medium rounded hover:bg-red-600 cursor-pointer ease-in-out duration-300">Cancel</a>
                                </form>
                            </div>
                        </div>
                    </div>
