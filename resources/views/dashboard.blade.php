                        ...
                        <div>
                            <div class="rounded-xl border p-5 shadow-md w-9/12 bg-white mt-5">
                                ...
                                <div class="flex items-center space-x-8">
                                    <button class="rounded-2xl border bg-neutral-100 px-3 py-1 text-xs font-semibold text-gray-500">Category</button>
                            ...
                            <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
                                <div class='max-w-md mx-auto space-y-6'>
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <textarea name="" id="" class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded" rows="5"></textarea>
